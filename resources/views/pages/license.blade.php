...
<div class="row">
  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 offset-xl-3 offset-lg-3 offset-md-3 offset-sm-3 offset-3" style="margin-top:20px;margin-bottom:20px;">
    <h2>关于我们</h2>
    <p class="h5 mt-3">
      cc0tuku提供高质量且完全免费的素材图片，这些图片均在cc0tuku许可下授权。我们精心地为所有图片贴上了标签，你可以搜索，也可以轻松通过我们的发现页面发现这些图片。
    </p>
    <h2 class="mt-5">图片</h2>
    <p class="h5 mt-3">
      我们有成千上万的免费素材图片，每天都会添加新的高分辨率图片。所有图片都是从我们用户上传的图片或免费图片网站上精心挑选的。我们确保所有发布的图片都是高质量的图片，并在cc0tuku许可下授权。
    </p>
    <h2 class="mt-5">贡献</h2>
    <p class="h5 mt-3">
      上传你自己的图片来支持cc0tuku社区：
    </p>
    <p>
    ...
    <p class="h5 mt-3">
      1.cc0tuku上的所有图片均可免费使用。
    </p>
    <p class="h5">
      2.无需注明归属。注明摄影作者或cc0tuku不是强制的，但这种行为值得赞赏。
    </p>
    <p class="h5">
      3.你可以修改cc0tuku上的图片。发挥创造力，随心所欲地编辑图片。
    </p>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">使用cc0tuku上的图片制作独特的广告、标语和营销活动资料，推广你的产品。</p>
                </div>
              </div>
            </div>
          </div>
